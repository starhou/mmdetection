...
#load_from  = './work_dirs/yolox_s_swin_drone/epoch_8.pth'
# model settings
model = dict(
    type='YOLOX',
    ...
    neck=dict(
        ...
        num_csp_blocks=1),
    bbox_head=dict(
        type='YOLOXHead', num_classes=4, in_channels=192, feat_channels=192),
